...
- [`3058ede`](https://github.com/clauderic/dnd-kit/commit/3058ede91dff4e1f5ff399d5c1d04c8681c411f6) Thanks [@clauderic](https://github.com/clauderic)! - Simplified instance management of `manager` to fix a bug where the `manager` returned by `useDragDropManager` was `null` on first mount.
